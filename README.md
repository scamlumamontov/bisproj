...
- Like button
- Favourites
- Partial indexing (SQLite)

The original ER diagram and Use Case diagram were created as part of the project presentation.
Due to file loss, the diagram source files are no longer available in this repository.
